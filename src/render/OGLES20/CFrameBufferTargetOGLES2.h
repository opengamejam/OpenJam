...
#ifndef CFRAMEBUFFERRENDERTARGETOGLES2_H
#define CFRAMEBUFFERRENDERTARGETOGLES2_H
...
class CFrameBufferTargetOGLES2 : public IRenderTarget
{
public:
    CFrameBufferTargetOGLES2(unsigned int width, unsigned int height);
    virtual ~CFrameBufferTargetOGLES2();
...
#endif /* defined(CFRAMEBUFFERRENDERTARGETOGLES2_H) */
