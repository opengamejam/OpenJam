...
CShaderProgramOGLES2_0::CShaderProgramOGLES2_0()
: m_ProgramObject(0)
, m_IsLinked(false)
{
...
void CShaderProgramOGLES2_0::Bind()
{
    glUseProgram(m_ProgramObject);
}

void CShaderProgramOGLES2_0::Unbind()
{
    glUseProgram(0);
}

void CShaderProgramOGLES2_0::AttachShader(IShaderPtr shader)
{
...
void CShaderProgramOGLES2_0::DetachShader(IShader::ShaderType shaderType)
{
...
bool CShaderProgramOGLES2_0::IsShaderAttached(IShader::ShaderType shaderType)
{
    std::map<IShader::ShaderType, IShaderPtr>::const_iterator it = m_AttachedShaders.find(shaderType);
...
bool CShaderProgramOGLES2_0::IsLinked() const
{
    return m_IsLinked;
}
...
void CShaderProgramOGLES2_0::UpdateUniforms() const
{
