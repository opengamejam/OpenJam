...
uint32_t CShaderProgramVulkan::VertexPosition()
{
    return m_CachedAttributes["MainVertexPosition"];
}

uint32_t CShaderProgramVulkan::VertexNormal()
{
    return m_CachedAttributes["MainVertexNormal"];
}

uint32_t CShaderProgramVulkan::VertexUV()
{
    return m_CachedAttributes["MainVertexUV"];
}

uint32_t CShaderProgramVulkan::VertexColor()
{
    return m_CachedAttributes["MainVertexColor"];
}

uint32_t CShaderProgramVulkan::MainTexture()
{
    return m_CachedUniforms["MainTexture0"];
}

uint32_t CShaderProgramVulkan::MainColor()
{
...
uint32_t CShaderProgramVulkan::Texture(uint32_t index)
{
    std::stringstream ss;
...
uint32_t CShaderProgramVulkan::DiffuseTexture()
{
    return m_CachedUniforms["MainTexture0"];
}

uint32_t CShaderProgramVulkan::NormalTexture()
{
    return m_CachedUniforms["MainTexture1"];
}

uint32_t CShaderProgramVulkan::SpecularTexture()
{
    return m_CachedUniforms["MainTexture2"];
}

uint32_t CShaderProgramVulkan::EnvironmentTexture()
{
