...
typedef CVector<uint32_t, 1> CVector1Dui;
...
typedef CVector<uint32_t, 2> CVector2Dui;
...
typedef CVector<uint32_t, 3> CVector3Dui;
...
typedef CVector<uint32_t, 4> CVector4Dui;
