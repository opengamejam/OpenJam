...
#ifndef CFRAMEBUFFEROGLBASE_H
#define CFRAMEBUFFEROGLBASE_H
...
class CFrameBufferOGLBase : public IFrameBuffer
{
public:
    CFrameBufferOGLBase(uint32_t width, uint32_t height);
    virtual ~CFrameBufferOGLBase();
