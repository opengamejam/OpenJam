...
public:
    ...
    {
        return (Position().x == 0.0f && Position().y == 0.0f && Position().z == 0.0f && Rotation().x == 0.0f && Rotation().y == 0.0f && Rotation().z == 0.0f && Scale().x == 0.0f && Scale().y == 0.0f && Scale().z == 0.0f);
    }

    INL bool operator==(const CTransform<T, Vec, Mat>& other) const
    {
        return (Position().x == other.Position().x && Position().y == other.Position().y && Position().z == other.Position().z && Rotation().x == other.Rotation().x && Rotation().y == other.Rotation().y && Rotation().z == other.Rotation().z && Scale().x == other.Scale().x && Scale().y == other.Scale().y && Scale().z == other.Scale().z);
    }
